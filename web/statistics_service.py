...
def _order_type_label(o):
    kind=getattr(o,"order_type",None)
    if kind=="partner_delivery": return "Доставка от партнёров"
    return "Доставка" if kind=="delivery" else "Обычная поездка"
