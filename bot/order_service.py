...
def offer_to_next_driver(
    ...
    # As soon as a free driver receives the offer and is choosing an ETA, keep
    # the passenger informed instead of leaving only the generic search text.
    if order.offer_outbox_id and creator and not _is_dispatcher_order(order):
